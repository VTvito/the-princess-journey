...
**[▶ Gioca / Play](https://gameforprincess.vercel.app)** · License: MIT · Built with [Kaplay](https://kaplayjs.com/) — no build step
...
([`tools/gen/`](tools/gen/)), the Playwright test harness, and the iOS/PWA performance work —
with a human in the loop steering direction, reviewing every change, and testing on real devices.

It's a small showcase of **agentic, AI-assisted development**: pairing human product taste and
on-device QA with an AI agent that can refactor, generate assets, and write tests across the whole
codebase. Curious about the workflow? Open an issue or reach out.

## Credits & license

- **Engine:** [Kaplay](https://kaplayjs.com/) `3001.0.19` — MIT, vendored at
  [`vendor/kaplay-3001.0.19.mjs`](vendor/kaplay-3001.0.19.mjs).
- **Font:** [Pixelify Sans](https://github.com/eifetx/Pixelify-Sans) — SIL Open Font License (OFL).
- **Art & audio:** all sprites, tiles, backgrounds and music/SFX are **original**, procedurally
  generated by [`tools/gen/`](tools/gen/) (`npm run gen`) — no third-party asset packs.
